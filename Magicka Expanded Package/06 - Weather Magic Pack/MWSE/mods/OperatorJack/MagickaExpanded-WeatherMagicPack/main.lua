...
require(
    "OperatorJack.MagickaExpanded-WeatherMagicPack.effects.thunderboltEffect")
...
local weatherTomes = {
    {id = "OJ_ME_TomeIceBarrage", spellId = weatherSpellIds.iceBarrage},
    {id = "OJ_ME_TomeThunderbolt", spellId = weatherSpellIds.thunderbolt},
    {id = "OJ_ME_TomeEntomb", spellid = weatherSpellIds.entomb}, {
